...
export const pigeonEnvironmentSchema = {
  ...
  CALLS_TURN_PORT: { type: 'number' },
  CALLS_TURN_PUBLIC_HOST: { type: 'string' },
  ...
  PIGEON_BOOTSTRAP_RELAY_MULTIADDRS: { type: 'string' },
  PIGEON_IPFS_ROUTING_RECORD_TIMEOUT_MS: { type: 'number' },
  PIGEON_LIBP2P_PORT: { defaultValue: 4001, type: 'number' },
  PIGEON_LOCAL_DB_PATH: { type: 'string' },
  PIGEON_PRIVATE_RELAY_BOOTSTRAP_MULTIADDRS: { type: 'string' },
  ...
  PIGEON_PRIVATE_RELAY_PORT_END: { type: 'number' },
  PIGEON_PRIVATE_RELAY_PORT_START: { type: 'number' },
  PIGEON_PRIVATE_RELAY_RECORD_GENERIC_DHT_ENABLED: {
    defaultValue: true,
    type: 'boolean',
  },
  PIGEON_PRIVATE_RELAY_RECORD_PUBSUB_ENABLED: {
    defaultValue: true,
    type: 'boolean',
  },
  ...
  PIGEON_PUBLIC_HOST: { type: 'string' },
  PIGEON_PUBLIC_RELAY_RECORDS_PATH: { type: 'string' },
  PIGEON_RELAY_AUTO_ENABLE: { defaultValue: false, type: 'boolean' },
  PIGEON_RELAY_DATA_LIMIT_BYTES: {
    defaultValue: 64 * 1024 * 1024,
    type: 'number',
  },
  PIGEON_RELAY_DIRECTORY_ROUTING_TIMEOUT_MS: { type: 'number' },
  PIGEON_RELAY_DISCOVERY_ENABLED: { defaultValue: true, type: 'boolean' },
  PIGEON_RELAY_ENABLED: { type: 'boolean' },
  PIGEON_RELAY_PORT: { defaultValue: 4011, type: 'number' },
  PIGEON_RELAY_PORT_END: { type: 'number' },
  PIGEON_RELAY_PORT_START: { type: 'number' },
