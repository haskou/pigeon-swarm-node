...
import { StickerEmoji } from './value-objects/StickerEmoji';
...
export class StickerDetails {
  public static fromPrimitives(
    ...
    return new StickerDetails(
      ...
      primitives.emojis.map((emoji) => new StickerEmoji(emoji)),
    );
  }
  ...
  constructor(
    ...
    private readonly emojis: StickerEmoji[],
  ) {}

  public getEmojis(): StickerEmoji[] {
    return this.emojis;
  }
  ...
  public toPrimitives() {
    return {
      ...
      emojis: this.emojis.map((emoji) => emoji.valueOf()),
