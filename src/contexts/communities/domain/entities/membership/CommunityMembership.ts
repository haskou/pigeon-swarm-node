...
export class CommunityMembership {
  ...
  public updateRole(
    ...
    this.roles.update(roleId, name, permissions);
  }

  public deleteRole(roleId: CommunityRoleId): void {
  ...
  public memberHasPermission(
    ...
    return this.roles.memberHasPermission(identityId, permission);
  }
  ...
  public memberHasAnyRole(
    ...
    return this.roles.memberHasAnyRole(identityId, roleIds);
  }
