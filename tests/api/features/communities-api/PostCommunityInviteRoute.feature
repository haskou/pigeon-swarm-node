Feature: Post community invite API
  ...
  Scenario: Owner creates an invite and another identity accepts it
    ...
    And I register a private IPFS network "communities-api-invite-network"
  ...
  Scenario: Owner creates an invite with an encrypted community key
    Given I am an anonymous user
    And I register a private IPFS network "communities-api-encrypted-invite-network"
    And I set a private community body
    And I sign the current community creation request
    When I POST to "/communities/"
    Then response code is equal to 200
  ...
  Scenario: Invite cannot be accepted more times than allowed
    Given I am an anonymous user
    And I register a private IPFS network "communities-api-invite-max-uses-network"
    And I set a private community body
    And I sign the current community creation request
    When I POST to "/communities/"
    Then response code is equal to 200
  ...
  Scenario: Expired invite cannot be accepted
    Given I am an anonymous user
    And I register a private IPFS network "communities-api-expired-invite-network"
    And I set a private community body
    And I sign the current community creation request
    When I POST to "/communities/"
    Then response code is equal to 200
  ...
  Scenario: Expired invite cannot be read
    Given I am an anonymous user
    And I register a private IPFS network "communities-api-expired-invite-read-network"
    And I set a private community body
    And I sign the current community creation request
    When I POST to "/communities/"
    Then response code is equal to 200
  ...
  Scenario: Exhausted invite cannot be read
    Given I am an anonymous user
    And I register a private IPFS network "communities-api-exhausted-invite-read-network"
    And I set a private community body
    And I sign the current community creation request
    When I POST to "/communities/"
    Then response code is equal to 200
